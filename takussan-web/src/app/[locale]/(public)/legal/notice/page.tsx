...
/**
 * `/[locale]/legal/notice` — TCK-531, `docs/features.md` §2.10. Le texte : `src/content/legal/notice.ts`.
 *
...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...(await metadonneesLegales('notice')),
    robots: { index: false, follow: true },
  };
}

export default function Page() {
  return <PageLegale document="notice" />;
}
