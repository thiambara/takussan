 ...
 *
 * ⚠️ **Le corps est ici et non dans `page.tsx` depuis TCK-431**, et c'est ce découpage qui rend le
 * `robots: { index: false }` possible : les commutateurs de palette et de typographie exigent
 * `useState`, donc `'use client'`, et un composant client ne peut pas porter de `metadata`. La
 * page voisine est un composant SERVEUR qui ne fait que déclarer la métadonnée et rendre celui-ci.
 */
