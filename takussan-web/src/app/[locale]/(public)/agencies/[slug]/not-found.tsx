...
/**
 * L'écran d'une agence qui n'existe pas (TCK-438).
 *
 ...
 * même segment est attrapé par la frontière du segment **parent** (`agencies/not-found.tsx`), pas
...
export default function NotFound() {
  const t = useTranslations('agency.publicPage');
