...
/**
 * TCK-426 — ce repli vit dans le GROUPE `(liste)`, et non plus à `leases/`.
 *
 * Posé un cran plus haut, il était l'ANCÊTRE de `leases/onboarding-pending`, dont le
 ...
 *
 * Un groupe de routes ne consomme aucun segment d'URL : `/app/leases` reste servie par
