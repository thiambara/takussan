    ...
    <footer className={`bg-slate-900 text-white ${className || ''}`}>
      <div className="max-w-[1440px] mx-auto px-8 md:px-16 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-3 rounded-lg bg-slate-800 border border-slate-700 text-white placeholder:text-slate-500 focus:outline-none focus:border-[#0050cb]"
              />
              <button className="px-6 py-3 bg-[#0050cb] hover:bg-[#0043a8] rounded-lg font-semibold transition-colors">
                S&apos;inscrire
              </button>
            </div>
          </div>
          ...
          <div>
            <h4 className="font-bold text-lg mb-4">Aide</h4>
            <ul className="space-y-3">
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex gap-4">
            <a
              href="#"
              className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 hover:bg-[#0050cb] hover:text-white transition-colors"
            >
              <FacebookIcon />
            </a>
            <a
