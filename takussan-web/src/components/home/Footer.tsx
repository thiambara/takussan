 ...
 * · Or ce jeton-là existe déjà ailleurs, sous le nom de voile (`.scrim`), livré par un autre
 *   chantier pour les surfaces qui doivent rester sombres des deux côtés. **En créer un second
