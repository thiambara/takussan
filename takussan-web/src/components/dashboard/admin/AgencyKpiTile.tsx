 ...
 */
export function AgencyKpiTile({ label, value, hint, accent = 'default', className }: Props) {
  return <StatCard label={label} value={value} hint={hint} accent={accent} className={className} />;
}
