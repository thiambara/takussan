...
import { Activity, BarChart3, Bell, Building2, CreditCard, FlaskConical, Home, LayoutDashboard, ListTree, Megaphone, PlugZap, Send, Settings2, ShieldAlert, ShieldCheck, Siren, SlidersHorizontal, Tags, Users } from 'lucide-react';
