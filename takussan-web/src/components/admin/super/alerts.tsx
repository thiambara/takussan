      ...
      <DialogContent className="sm:max-w-lg">
        ...
        <div className="space-y-3">
          <label className="block space-y-1.5">
            <Label htmlFor="alert-event">Événement</Label>
          ...
          <label className="block space-y-1.5">
            <Label htmlFor="alert-channels">Canaux</Label>
            <Input id="alert-channels" value={channels} onChange={(e) => setChannels(e.target.value)} placeholder="email,slack,discord" />
          </label>
          <label className="block space-y-1.5">
            <Label htmlFor="alert-emails">Emails</Label>
            <Input id="alert-emails" value={emails} onChange={(e) => setEmails(e.target.value)} placeholder="ops@example.com" />
          </label>
          <label className="block space-y-1.5">
            <Label htmlFor="alert-webhooks">Webhooks</Label>
            <Input id="alert-webhooks" value={webhooks} onChange={(e) => setWebhooks(e.target.value)} placeholder="https://hooks.slack.com/..." />
          </label>
        </div>
