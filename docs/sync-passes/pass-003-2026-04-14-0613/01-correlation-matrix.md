# Matrice de corrélation — Passe 003

Légende : ✅ pleinement supporté · ⚠️ partiellement supporté ou capacité latente · ❌ non supporté.

> **Note de stabilité :** ni `docs/features.md` ni `docs/models-spec.md` n'ont été modifiés depuis la passe 001 (commit `57bd3ed`). La matrice ci-dessous est donc identique à celles des passes 001 et 002 — elle est reproduite intégralement pour permettre la lecture autonome de la passe 003, mais aucun statut n'a évolué.
...
**Bilan modèles :** 28 / 28 ✅, identique aux passes 001 et 002.
