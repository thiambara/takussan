# INDEX manuel — gelé le 2026-08-12

> **Archive. Ce document ne décrit pas l'état du backlog.** L'index vivant est
> [`../INDEX.md`](../INDEX.md), généré depuis les frontmatters des tickets.
>
> Ce fichier est la **dernière version maintenue à la main** de l'INDEX, conservée telle quelle
> pour deux contenus rédigés que la génération ne sait pas produire : la section
> **« Graphe de dépendances »** (213 lignes) et la section **« Historique »** (24 entrées, très
> détaillées, qui racontent le déroulé des vagues 1 à 3 et la réconciliation d'avril).
>
> **Ce qu'il faut savoir avant de s'en servir**, mesuré le 2026-08-12 :
>
> - **Le placement en colonne est faux sur 213 de ses 266 entrées (80,1 %).** Il montre 40 tickets
>   à faire et 177 en review là où les frontmatters en comptaient 3 et 2. Ne jamais lire un statut
>   ici.
> - **L'« Historique » s'arrête au 2026-04-25**, à TCK-109 — il ne couvre donc pas les 171 tickets
>   suivants (65 % du backlog, dont le design system, les profils polymorphes, la refonte RBAC, la
>   recherche Meilisearch et le canal WhatsApp).
> - **Le « Graphe de dépendances » ne couvre que 158 des 265 tickets** (40 % absents) : il n'a pas
>   suivi la croissance du backlog.
>
> Ce qui reste vrai et utile : la **narration** des vagues 1 à 3, les numéros de PR, et le détail
> des arbitrages de scission de tickets d'avril 2026.
...
_(TCK-282 + TCK-283 en review — voir section Review)_
...
### Vague 35 — Recherche Meilisearch
