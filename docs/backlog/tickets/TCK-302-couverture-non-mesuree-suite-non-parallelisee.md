...
- [x] AC3 — si la parallélisation est activée, cinq exécutions consécutives rendent 0 échec ; sinon
      ...
      **5 exécutions sur 5 rouges**, dont un intermittent (3/5) qui a révélé [TCK-313](TCK-313-test-recherche-dependant-de-l-ordre.md)
...
Ticket : **TCK-313**. Le mécanisme exact n'a pas été identifié, et c'est délibérément laissé au
...
# parallélisation — À NE REJOUER QU'APRÈS TCK-313 et l'arbitrage des gardes de FakeDiskIsolationTest
