...
- [TCK-079](tickets/TCK-079-payment-gateway-wave-orange.md) — Passerelle de paiement Wave / Orange Money / Stripe `XL · P2 · applicatif`
...
- [TCK-083](tickets/TCK-083-crm-prospect-pipeline.md) — Pipeline de prospects CRM (kanban + conversion) `M · P2 · applicatif`
...
── Vague 7 : Enrichissement P2 (hors-périmètre V4-V6) ──
TCK-028 + TCK-068 ──▶ TCK-079 (payment gateway Wave/OM/Stripe)
