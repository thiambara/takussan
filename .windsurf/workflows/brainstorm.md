---
description: BEFORE any creative work — creating features, building components, adding functionality, or modifying behavior. Explores user intent, requirements and design before implementation.
---
...
You MUST create a `todo_list` for each of these items and complete them in order:
...
8. **Transition to implementation** — read and follow `/plan` workflow to create implementation plan
...
- Read and follow the `/plan` workflow to create a detailed implementation plan
- Do NOT start coding. `/plan` is the next step.
