...
class SearchWolofReviewSheet extends Command
{
    ...
    private function consignes(): void
    {
        ...
        $this->line('  <options=bold>Property::CONTRACT_SEARCH_ALIASES_WO</>, jamais dans lang/wo/ : `docker/release.sh`');
        $this->line('  réimporte l\'index quand change l\'empreinte des modèles indexés, de config/scout.php,');
        $this->line('  de app/Support/Search/ ou de lang/fr/properties.php (le libellé de type');
