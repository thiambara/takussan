...
/**
 * TCK-305 — extrait de PhoneVerificationController::verify(), où les règles étaient écrites en ligne.
 *
 ...
 */
class VerifyPhoneVerificationRequest extends BaseFormRequest
{
    /**
