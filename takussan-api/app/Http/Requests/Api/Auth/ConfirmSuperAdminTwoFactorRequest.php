...
/**
 * TCK-305 — extrait de SuperAdminTwoFactorController::confirm(), où les règles étaient écrites en ligne.
 *
 ...
 */
class ConfirmSuperAdminTwoFactorRequest extends BaseFormRequest
{
    /**
    ...
    {
        return (bool) ($this->user()?->force_2fa_at_first_login);
    }
