...
/**
 * TCK-305 — extrait de AgencyController::addAgent(), où les règles étaient écrites en ligne.
 *
 ...
 */
class AddAgentAgencyRequest extends BaseFormRequest
{
    /**
    ...
    {
        return $this->user()?->can('update', $this->route('agency')) === true;
    }
