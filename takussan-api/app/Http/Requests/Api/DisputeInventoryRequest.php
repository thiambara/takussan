...
/**
 * TCK-305 — extrait de InventoryController::dispute(), où les règles étaient écrites en ligne.
 *
 ...
 */
class DisputeInventoryRequest extends BaseFormRequest
{
    /**
    ...
    {
        return $this->user()?->can('view', $this->route('inventory')) === true;
    }
