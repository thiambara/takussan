...
/**
 * TCK-305 — extrait de AgentProfileController::updateSpecialization(), où les règles étaient écrites en ligne.
 *
 ...
 */
class UpdateSpecializationAgentProfileRequest extends BaseFormRequest
{
    ...
    /**
     * TCK-305 — spécialisations autorisées ; elles vivaient en `private const` sur le
     * contrôleur, donc hors de portée des règles une fois déplacées.
     *
     * @var list<string>
     */
    public const ALLOWED_SPECIALIZATIONS = ['residential', 'commercial', 'luxury', 'mixed'];
