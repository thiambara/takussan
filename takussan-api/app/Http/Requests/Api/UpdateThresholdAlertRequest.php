...
/**
 * TCK-305 — extrait de ThresholdAlertController::update(), où les règles étaient écrites en ligne.
 *
 ...
 */
class UpdateThresholdAlertRequest extends BaseFormRequest
{
    /**
    ...
    {
        $user = $this->user();
        $alert = $this->route('threshold_alert');
