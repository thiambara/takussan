...
/**
 * TCK-305 — extrait de PropertyVisitController::cancel(), où les règles étaient écrites en ligne.
 *
 ...
 */
class CancelPropertyVisitRequest extends BaseFormRequest
{
    /**
    ...
    {
        return $this->user()?->can('view', $this->route('visit')) === true;
    }
