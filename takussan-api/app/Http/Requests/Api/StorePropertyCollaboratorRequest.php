...
/**
 * TCK-305 — extrait de PropertyCollaboratorController::store(), où les règles étaient écrites en ligne.
 *
 ...
 */
class StorePropertyCollaboratorRequest extends BaseFormRequest
{
    /**
