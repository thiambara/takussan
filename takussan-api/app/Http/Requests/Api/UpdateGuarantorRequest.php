...
/**
 * TCK-305 — extrait de GuarantorController::update(), où les règles étaient écrites en ligne.
 *
 ...
 */
class UpdateGuarantorRequest extends BaseFormRequest
{
    /**
    ...
    {
        return $this->user()?->can('view', $this->route('guarantor')) === true;
    }
