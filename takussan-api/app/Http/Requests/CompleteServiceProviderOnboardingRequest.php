...
/**
 * TCK-305 — extrait de ServiceProviderOnboardingController::complete(), où les règles étaient écrites en ligne.
 *
 ...
 */
class CompleteServiceProviderOnboardingRequest extends BaseFormRequest
{
    /**
